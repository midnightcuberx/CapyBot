...
async def help(ctx, *, help_type=None):
    ...
    if not help_type or help_type.lower() not in help_list:
        ...
        embed.add_field(name="gamble", value="gamble, invest, blackjack", inline=False)
        embed.add_field(name="crime", value="rob, murder, fight", inline=False)
        ...
        if help_type.lower() == "misc":
            ...
            embed.add_field(
                ...
                value="try your hand at blackjack!",
                inline=False,
            )
            ...
            embed.add_field(name="``-fight <user> <money (optional)>``", value="fight someone", inline=False)
